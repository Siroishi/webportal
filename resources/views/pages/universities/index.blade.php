...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-8">Университеты</h1>

    <x-search route="universities.index" placeholder="Поиск по университетам..." />
        ...
        @foreach($universities as $university)
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div class="mb-4">
                        <h3 class="text-sm font-medium text-gray-900 mb-2">Факультеты:</h3>
